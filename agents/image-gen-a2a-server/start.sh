...
if check_port 10000 1; then
    echo "port 10000 is occupied, run restart.sh to restart service"
...
# 检测10000端口
if check_port 10000 30; then
    echo "✅ A2A service started"
    echo "service on http://localhost:10000"
    echo "process ID: $PID"
else
    echo "❌ service failed to start"
